...
@section('content')
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <nav class="text-sm text-gray-600 mb-4">
            ...
            <span class="text-gray-800">Fournisseur national</span>
            <span class="mx-2">></span>
            <span class="text-gray-800">Suspension de compte</span>
        </nav>

        <!-- Titre -->
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Formulaire de Suspension de Compte - Fournisseur National</h1>
        ...
        <form method="POST">
            ...
            <div class="mb-8 p-4 border border-gray-300 rounded-lg bg-gray-50 shadow-sm">
                <h2 class="text-xl font-semibold text-gray-700 mb-4">Raison de la Suspension</h2>
                <div>
            ...
            <div class="mb-8 p-4 border border-gray-300 rounded-lg bg-gray-50 shadow-sm">
                ...
                <div class="flex items-center">
                    ...
                    <label for="confirmation" class="ml-2 block text-sm text-gray-700">
                        Je confirme la suspension de ce compte.
                    </label>
                    @error('confirmation')
