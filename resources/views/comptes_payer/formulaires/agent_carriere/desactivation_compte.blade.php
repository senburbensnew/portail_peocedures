...
@section('content')
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <nav class="text-sm text-gray-600 mb-4">
            ...
            <span class="text-gray-800">Agent Carriere</span>
            <span class="mx-2">></span>
            <span class="text-gray-800">Désactivation de Compte</span>
        </nav>

        <!-- Titre -->
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Formulaire de Désactivation de Compte - Agent Carriere</h1>
        ...
        <form method="POST">
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="px-4 py-2 bg-yellow-500 text-white font-medium text-sm rounded hover:bg-yellow-700 focus:outline-none focus:ring focus:ring-yellow-300">
