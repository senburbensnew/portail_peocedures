...
@section('content')
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <nav class="text-sm text-gray-600 mb-4">
            ...
            <span class="text-gray-800">Agent de Carriere</span>
            <span class="mx-2">></span>
            <span class="text-gray-800">Ouverture de compte</span>
        </nav>

        <!-- Titre -->
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Formulaire d'Ouverture de Compte - Agent de Carriere</h1>
