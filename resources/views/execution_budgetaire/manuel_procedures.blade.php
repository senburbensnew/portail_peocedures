...
@section('content')
    <div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <nav class="text-sm text-gray-600 mb-4">
            <span class="text-gray-800">Exécution budgetaire</span>
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ asset('documents/execution-budgetaire-mp.pdf') }}" download
        ...
        <div class="border border-gray-300 rounded-lg overflow-hidden">
            <embed src="{{ asset('documents/execution-budgetaire-mp.pdf') }}" type="application/pdf" width="100%"
